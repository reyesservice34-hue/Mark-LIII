...
registerModule({ id: "teach", component: lazy(() => import("@/modules/teach/TeachPage")), routes: [":procedureId"] });
registerModule({ id: "desktop", component: lazy(() => import("@/modules/desktop/DesktopPage")) });
